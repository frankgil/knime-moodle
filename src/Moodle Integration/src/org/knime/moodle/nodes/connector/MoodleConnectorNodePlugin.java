 ...
 * @author Fran Gil
 */
public class MoodleConnectorNodePlugin extends Plugin {
    // The shared instance.
    private static MoodleConnectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public MoodleConnectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MoodleConnectorNodePlugin getDefault() {
        return plugin;
    }
