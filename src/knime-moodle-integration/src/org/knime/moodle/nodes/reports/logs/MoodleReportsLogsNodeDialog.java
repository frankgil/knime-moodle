 ...
 * @author Fran Gil
 */
public class MoodleReportsLogsNodeDialog extends DefaultNodeSettingsPane {

	/**
	 * New dialog pane for configuring the node. The dialog created here
	 * will show up when double clicking on a node in KNIME Analytics Platform.
	 */
    protected MoodleReportsLogsNodeDialog() {
        super();
		...
		SettingsModelString stringSettings = MoodleReportsLogsNodeModel.createNumberFormatSettingsModel();
